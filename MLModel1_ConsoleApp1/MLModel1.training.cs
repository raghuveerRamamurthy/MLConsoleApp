...
namespace MLModel1_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\mynam\Downloads\housing.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"ocean_proximity", @"ocean_proximity", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=2816,NumberOfIterations=235,MinimumExampleCountPerLeaf=20,LearningRate=0.479539877117941,LabelColumnName=@"median_house_value",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.388650617242863,FeatureFraction=0.914986343280163,L1Regularization=7.4147768138565E-10,L2Regularization=0.999999776672986},MaximumBinCountPerFeature=228}));
